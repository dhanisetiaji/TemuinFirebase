...
namespace temuinFix.Views
{
    ...
    public partial class Dashboard : ContentPage
    {
        ...
        {
            await firebaseHelper.AddPerson(Convert.ToInt32(txtId.Text), txtName.Text, txtDescription.Text);
        ...
        {
            await firebaseHelper.UpdatePerson(Convert.ToInt32(txtId.Text), txtName.Text, txtDescription.Text);
            txtId.Text = string.Empty;
            txtName.Text = string.Empty;
            txtDescription.Text = string.Empty;
